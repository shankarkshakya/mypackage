#' @title Convert segregating sites to codons
#' @description The function returns the codons for segregating sites.
#' @param DNAbin object.
#' @return matrix of amino acids
#'
#' @details
#' Convert your segregating sites from dnabin to return AA change.
#'
#' @example
#' library(ape)
#' data("woodmouse")
#' seg.sites2codons(woodmouse)
#'
#' @export
